<aside class="right-side">                
    <section class="content-header">
      	<h1>Stations</h1>
      	<ol class="breadcrumb">
			<li><button class="btn btn-success pull-right" data-toggle="modal" data-target="#AddStationModal"><i class="fa fa-plus"></i> add station</button></li>
        </ol>
    </section>
...
$("#railway_stations_list").on("click", ".edit", function(){
	...
	var district_name = $editing.closest("tr").find(".district_name").text();
