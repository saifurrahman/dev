...
function printDiv()
{
  ...
  var divToPrint=document.getElementById('panel_testing_report');
  newWin= window.open("");

  newWin.document.write('<h3>Panel testing report for Station/LC Gate </h3>');
...
$("#excel_report").click(function() {
	$("#panel_testing_report").table2excel({
		exclude : ".noExl",
    name : "panel_testing_report",
    filename: "panel_testing_report"
	});
});
