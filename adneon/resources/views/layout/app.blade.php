...
<link href="packages/css/addneon.css" rel="stylesheet" type="text/css">
<link href="packages/css/jquery-ui.min.css" rel="stylesheet" type="text/css">
<link href="packages/css//selectize.bootstrap3.css" rel="stylesheet" type="text/css">
<link href="packages/css/alertify.min.css" rel="stylesheet" type="text/css">
...
<script src="packages/js/selectize.min.js"></script>
<script src="packages/js/jquery.slimscroll.min.js"></script>
<script src="packages/js/app.plugin.js"></script>
<script src="packages/js/moment.js"></script>
<script src="packages/js/jquery.table2excel.min.js"></script>
<script src="packages/js/Chart.js"></script>
</head>
<body>
	<section class="vbox">
		<header
			...
			<div class="navbar-header aside-md dk">
				<a class="btn btn-link visible-xs"
					...
					class="fa fa-bars"></i>
				</a> <a href="{{URL::to('addneon/dashboard')}}" class="navbar-brand"> <span class="hidden-nav-xs">Adneon</span>
			...
			<ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"></span> <?php echo Session::get("name"); ?> <b
						class="caret"></b>
				</a>
